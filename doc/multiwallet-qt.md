...
In order to support loading of multiple wallets in tiberium-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tiberium.cpp.
...
Changes to tiberium.cpp
----------------------
tiberium.cpp is the entry point into tiberium-qt, and as such, will require some minor modifications to provide hooks for
