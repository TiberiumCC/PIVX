...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Tiberium Core tiberium-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tiberium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tiberium transaction") + "\n" +
                               "  tiberium-tx [options] -create [commands]   " + _("Create hex-encoded tiberium transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tiberium transaction
