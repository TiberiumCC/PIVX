                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TIBERIUM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TIBERIUM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tiberium: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTBR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TIBERIUM Core"), this);
    aboutAction->setStatusTip(tr("Show information about TIBERIUM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TIBERIUM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TIBERIUM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TIBERIUM addresses"));
    ...
    openAction->setStatusTip(tr("Open a TIBERIUM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TIBERIUM Core help message to get a list with possible TIBERIUM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TIBERIUM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TIBERIUM network", "", count));
}
...
{
    QString strTitle = tr("TIBERIUM Core"); // default title
