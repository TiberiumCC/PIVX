Contributing to TIBERIUM Core
============================

The TIBERIUM Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TIBERIUM Core project, and is not to be
confused with overall TIBERIUM Network Protocol consensus changes.

Whether a pull request is merged into TIBERIUM Core rests with the project merge
...
Patches that change TIBERIUM consensus rules are considerably more involved than
...
Where a patch set proposes to change the TIBERIUM consensus, it must have been
...
The project leader is the release manager for each TIBERIUM Core release.
