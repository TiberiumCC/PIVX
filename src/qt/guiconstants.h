...
/* Tiberium GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TIBERIUM"
#define QAPP_ORG_DOMAIN "tiberium.org"
#define QAPP_APP_NAME_DEFAULT "TIBERIUM-Qt"
#define QAPP_APP_NAME_TESTNET "TIBERIUM-Qt-testnet"
