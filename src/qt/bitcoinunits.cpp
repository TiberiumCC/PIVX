...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TBR);
    unitlist.append(mTBR);
    unitlist.append(uTBR);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TBR:
            return QString("tTBR");
        case mTBR:
            return QString("mtTBR");
        case uTBR:
            return QString::fromUtf8("μtTBR");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TBR:
            return QString("TBR");
        case mTBR:
            return QString("Milli-TBR (1 / 1" THIN_SP_UTF8 "000)");
        case uTBR:
            return QString("Micro-TBR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TBR:
            return QString("TestTBRs");
        case mTBR:
            return QString("Milli-TestTBR (1 / 1" THIN_SP_UTF8 "000)");
        case uTBR:
            return QString("Micro-TestTBR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
