...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TIBERIUM Core"),
     ...
     * override -datadir in the tiberium.conf file in the default data directory
     * (to be consistent with tiberiumd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
