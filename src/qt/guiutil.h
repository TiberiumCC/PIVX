...
/** Utility functions used by the TIBERIUM Qt UI.
 */
namespace GUIUtil
{
...
// Render TIBERIUM addresses in monospace font
...
// Parse "tiberium:" URI into recipient object, return true on successful parsing
